...
@dataclass
class DataConfig:
    # train_path: str = 'data/an4_train_manifest.csv'
    # val_path: str = 'data/an4_val_manifest.csv'
    train_path: str = '/root/autodl-tmp/deepspeech.pytorch-master/data/an4_dataset/train/an4/'
    val_path: str = '/root/autodl-tmp/deepspeech.pytorch-master/data/an4_dataset/val/an4'
